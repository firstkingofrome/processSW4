...
"""
Evaluate all three planes instead of just the two planes that I am using
...
drm_filename = "DRM_slice_model_162D.hdf5"
...
for coordinate in range(len(coordinateList)): 
    ...
    if(directivity == 'sw4_x'):
        ...
        loc_i,loc_j,loc_k = int(coordinateList[coordinate][0][0]/h)+int(int(parameterFile['x0'])/h),int(coordinateList[coordinate][0][1]/h),int((int(parameterFile['essi_z_end'])-coordinateList[coordinate][0][2])/h)
        ...
        #checkValues = lambda x:0 if x != 0 else x         
        loc_j,loc_i,loc_k = int(coordinateList[coordinate][0][0]/h)+int(int(parameterFile['y0'])/h),int(coordinateList[coordinate][0][1]/h),int((int(parameterFile['essi_z_end'])-coordinateList[coordinate][0][2])/h)
        #z stop if z is ever negetive!
        #assert loc_k >= 0
